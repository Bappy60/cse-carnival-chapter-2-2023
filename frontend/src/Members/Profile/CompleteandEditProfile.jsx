...
function CompleteandEditProfile({ type, nav }) {
    ...
    axios
      ...
      .then((result) => {
        ...
        if (result.data.dob)
          makeProfile = {
            ...result.data,
            language: result.data.languages[0],
            dobD: new Date(result.data.dob).getDate(),
            dobM: new Date(result.data.dob).getMonth() + 1,
            dobY: new Date(result.data.dob).getFullYear(),
          };
        else
          makeProfile = {
            ...result.data,
  ...
  const submit = (e) => {
    ...
    axios
      .put(`${baseURL}/normaluser/updateprofile`, dat)
      .then(
        (res) => {
          console.log(res);
          setSuccess(true);
  ...
  return (
    <div>
      ...
      <h3 style={{ fontSize: "35px", textAlign: "center" }}>
        {!nav ? "Complete Your Profile" : "Edit Profile"}
      </h3>
      <div
        style={{
          display: "flex",
              ...
              <div style={{ textAlign: "center" }}>
                ...
                >
                  <Select
                    ...
                    placeholder={"DD"}
                    onChange={(e) =>
                      setProfile({ ...profile, dobD: e.target.value })
                    }
                    sx={{
                      flex: 1,
                      display: "block",
                  ...
                  <Select
                    ...
                    placeholder={"MM"}
                    onChange={(e) =>
                      setProfile({ ...profile, dobM: e.target.value })
                    }
                    sx={{
                      flex: 2,
                      display: "block",
                  ...
                  <Select
                    ...
                    onChange={(e) =>
                      setProfile({ ...profile, dobY: e.target.value })
                    }
                    sx={{
                      flex: 3 / 2,
                      display: "block",
                  ...
                  >
                    {new Array(100).fill(null).map((v, i) => (
                      <MenuItem key={v} value={+new Date().getFullYear() - i}>
                ...
                >
                  ...
                  <div
                    style={{ flex: 1, alignSelf: "flex-end", textAlign: "end" }}
                  >
                    <button
                      onClick={submit}
                      style={{
