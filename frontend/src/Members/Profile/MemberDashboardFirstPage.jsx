...
function MemberDashboardFirstPage({
  profile,
  events,
  setCareProvider,
  setEventDetails,
    ...
    <div>
      ...
      {events.length > 0 && (
        ...
        >
          ...
          <button style={{ backgroundColor: "white", padding: "5px 20px" }}>
            <a
              href={events[0].meetingLink}
              style={{
      ...
      {events.length === 0 &&
        (pastAppoints.length > 0 ? !pastAppoints[0].reviewed : false) && (
          <div
            style={{
              background: "var(--primary-color, #62C227)",
              padding: "10px",
          ...
          >
            ...
            <NavLink to={`/member/review/${pastAppoints[0]._id}`}>
              <button
      ...
      <Stack direction="row" sx={{ alignItems: "center", gap: "20px" }}>
        ...
        >
          ...
          <span
            style={{ fontSize: "35px", color: "#62C227", fontWeight: "bold" }}
          >
            {profile.hours < 0 ? 0 : profile.hours} &nbsp;&nbsp;
          </span>
          <span>Hours</span>
        ...
        <Box sx={{}}>
          ...
          >
            ...
            >
              You deserve to be happy<br></br>Find the Right Care Provider For
              you
            </p>

            <NavLink to="/member/questions">
              <button
                style={{
      ...
      {events.length > 0 && (
        <Box>
          <h3
            style={{ fontSize: "35px", marginTop: "20px", textAlign: "start" }}
          >
            Next Appointment
          </h3>
          <NextAppointment
