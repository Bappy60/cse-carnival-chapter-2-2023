...
export default function OTPInput({ data, otp1, type }) {
  ...
  const submit = () => {
    ...
    if (type === "care") {
      axios
        .post(`${baseURL}/careprovider/createcareprovider`, data, {
          headers: {
      ...
      console.log(data);
      axios
        .post(`${baseURL}/normaluser/createuser`, data, {
          headers: {
            "Content-Type": "application/json",
          },
        })
      ...
      <div style={{ width: "65%", margin: "20px auto" }}>
        ...
        <div style={{ margin: "70px auto" }}>
          <OtpInput
            ...
            inputStyle={{
              border: "1px solid rgba(98, 194, 39, 1)",
              padding: "20px 20px",
              width: "40px",
              height: "40px",
              borderRadius: "20px",
